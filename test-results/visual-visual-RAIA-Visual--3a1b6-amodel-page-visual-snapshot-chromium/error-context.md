...
- Name: visual\visual.spec.ts >> RAIA Visual Regression Baseline Screenshots >> Metamodel page visual snapshot
- Location: tests\e2e\visual\visual.spec.ts:9:7

# Error details

```
Error: A snapshot doesn't exist at C:\Users\cesar\.gemini\antigravity\scratch\Red de Arquitectura de Industria Afores (RAIA)\tests\e2e\visual\visual.spec.ts-snapshots\metamodel-chromium-win32.png, writing actual.
```
