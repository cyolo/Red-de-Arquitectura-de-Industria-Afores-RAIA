...
- Location: tests\e2e\visual\visual.spec.ts:34:7

# Error details

```
Error: A snapshot doesn't exist at C:\Users\cesar\.gemini\antigravity\scratch\Red de Arquitectura de Industria Afores (RAIA)\tests\e2e\visual\visual.spec.ts-snapshots\business-scenarios-chromium-win32.png, writing actual.
```
