...
- Name: business-scenarios\all-scenarios.spec.ts >> All Business Scenarios Parameterized E2E Verification >> RAIA-BS-0013: Verify complete scenario layout and element rendering
...
- main:
  - complementary:
    ...
    - button "Ayuda para gastos de matrimonio 14 pasos estructurados" [pressed]
  ...
  - link "Volver al Portal Principal":
    - /url: /
  - text: "ID: RAIA-BS-0013 Proposed Pending Validation"
  - heading "Ayuda para gastos de matrimonio" [level=1]
  - figure "Ayuda para gastos de matrimonio":
    ...
    - img "Ayuda para gastos de matrimonio": Diagrama de secuencia vectorial con 13 participantes y 14 interacciones. sd RAIA-BS-0013 alt [Condiciones de Negocio] [else Derecho procedente] [else Derecho previamente ejercido] [else Información insuficiente] [else Pago fallido] Trabajador Gestión de Solicitudes Autenticación Expediente Electrónico Validación de Elegibilidad IMSS Cuenta Individual Gestión de Pagos Libro Mayor Notificaciones expediente validaci n Institución Financiera [1] Solicitar ayuda. [2] Validar identidad. [3] Recuperar documentación. [4] Evaluar derecho. [5] Consultar elegibilidad. [6] Entregar resultado. [7] Consultar información. [8] Entregar datos. [9] Autorizar pago. [10] Ejecutar pago. [11] Confirmar pago. [12] Registrar movimiento. [13] Emitir resolución. [14] Informar resultado.
  - tablist "Secciones del escenario":
    - tab "Pasos y Flujo" [selected]
    - tab "Narrativa Arquitectónica"
  - paragraph: Ayuda para gastos de matrimonio
  - region "Flujo y Pasos Estructurados (14)":
    - heading "Flujo y Pasos Estructurados (14)" [level=2]
    - button "1 Solicitar ayuda. Trabajador→Gestión de Solicitudes SYNCHRONOUS-COMMAND":
      - text: "1"
      - heading "Solicitar ayuda." [level=3]
