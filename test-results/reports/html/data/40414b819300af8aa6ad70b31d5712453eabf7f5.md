...
- Name: business-scenarios\scenarios.spec.ts >> Business Scenarios >> RAIA-BS-003: Selecting a scenario updates the view
- Location: tests\e2e\business-scenarios\scenarios.spec.ts:20:7
...
Locator:  locator('text=Propósito')
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('text=Propósito')
    13 × locator resolved to <h4 class="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400 mb-2">…</h4>
