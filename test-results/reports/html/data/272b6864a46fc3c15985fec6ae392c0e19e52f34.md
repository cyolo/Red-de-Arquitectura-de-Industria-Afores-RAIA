...
- Name: business-scenarios\all-scenarios.spec.ts >> All Business Scenarios Parameterized E2E Verification >> RAIA-BS-0010: Verify complete scenario layout and element rendering
...
- main:
  - complementary:
    ...
    - button "Ejecución y liquidación de operaciones 16 pasos estructurados" [pressed]
  ...
  - link "Volver al Portal Principal":
    - /url: /
  - text: "ID: RAIA-BS-0010 Proposed Pending Validation"
  - heading "Ejecución y liquidación de operaciones" [level=1]
  - figure "Ejecución y liquidación de operaciones":
    ...
    - img "Ejecución y liquidación de operaciones": Diagrama de secuencia vectorial con 17 participantes y 16 interacciones. sd RAIA-BS-0010 alt [Excepciones] [else Fallo de conexión] Gestión de Instrucciones Cumplimiento Preoperación Ejecución de Operaciones Contraparte Mercado Confirmación de Operaciones Liquidación Custodia Contabilidad de Inversiones Conciliación de Posiciones Riesgo de Inversión cumplimiento riesgo Ejecución Confirmación contabilidad Conciliación [1] Validar orden. [2] Validar límites. [3] Confirmar resultado. [4] Autorizar orden. [5] Enviar instrucción. [6] Ejecutar operación. [7] Cruzar operación. [8] Emitir confirmación. [9] Comparar términos. [10] Instruir liquidación. [11] Transferir valores. [12] Transferir efectivo. [13] Confirmar posición. [14] Registrar operación. [15] Conciliar posición. [16] Confirmar cierre.
  - tablist "Secciones del escenario":
    - tab "Pasos y Flujo" [selected]
    - tab "Narrativa Arquitectónica"
  - paragraph: Ejecución y liquidación de operaciones
  - region "Flujo y Pasos Estructurados (16)":
    - heading "Flujo y Pasos Estructurados (16)" [level=2]
    - button "1 Validar orden. Gestión de Instrucciones→cumplimiento SYNCHRONOUS-COMMAND":
      - text: "1"
      - heading "Validar orden." [level=3]
      - paragraph: Gestión de Instrucciones→cumplimiento
