...
- Name: metamodel\metamodel.spec.ts >> RAIA Metamodel Overview Page >> RAIA-META-003 & 004: Validate structural hierarchy and cardinalities
- Location: tests\e2e\metamodel\metamodel.spec.ts:14:7
...
Locator: getByTestId('metamodel-hierarchy')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('metamodel-hierarchy')
