...
- Name: business-scenarios\all-scenarios.spec.ts >> All Business Scenarios Parameterized E2E Verification >> RAIA-BS-0005: Verify complete scenario layout and element rendering
...
- main:
  - complementary:
    ...
    - button "Reasignación por desempeño 16 pasos estructurados" [pressed]
  ...
  - link "Volver al Portal Principal":
    - /url: /
  - text: "ID: RAIA-BS-0005 Proposed Pending Validation"
  - heading "Reasignación por desempeño" [level=1]
  - figure "Reasignación por desempeño":
    ...
    - img "Reasignación por desempeño": Diagrama de secuencia vectorial con 14 participantes y 16 interacciones. sd RAIA-BS-0005 alt [Condiciones de Negocio] [else Cuenta elegible] [else Cuenta no elegible] [else Falla en transferencia] [else Datos inconsistentes] CONSAR Métricas del Sistema Evaluación de Desempeño Gestión de Comisiones Reasignación de Cuenta BDNSAR AFORE de origen Transferencia de Recursos Libro Mayor Notificaciones eValuación Métricas reAsignación transferencia [1] Iniciar ciclo de evaluación. [2] Recuperar indicadores. [3] Recuperar comisiones vigentes. [4] Entregar resultados. [5] Entregar información. [6] Identificar cuentas elegibles. [7] Consultar cuentas asignadas. [8] Entregar universo elegible. [9] Solicitar información. [10] Entregar cuenta y saldos. [11] Solicitar recepción. [12] Confirmar recepción. [13] Ejecutar transferencia. [14] Registrar movimientos. [15] Actualizar responsable. [16] Comunicar resultado.
  - tablist "Secciones del escenario":
    - tab "Pasos y Flujo" [selected]
    - tab "Narrativa Arquitectónica"
  - paragraph: Reasignación por desempeño
  - region "Flujo y Pasos Estructurados (16)":
    - heading "Flujo y Pasos Estructurados (16)" [level=2]
    - button "1 Iniciar ciclo de evaluación. CONSAR→Evaluación de Desempeño SYNCHRONOUS-COMMAND":
      - text: "1"
      - heading "Iniciar ciclo de evaluación." [level=3]
      - paragraph: CONSAR→Evaluación de Desempeño
