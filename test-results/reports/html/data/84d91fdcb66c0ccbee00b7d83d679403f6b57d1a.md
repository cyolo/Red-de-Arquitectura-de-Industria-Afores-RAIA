...
- Name: business-scenarios\step-analysis.spec.ts >> RAIA Business Scenarios - Step Analysis Context >> mobile layout drawer behavior
- Location: tests\e2e\business-scenarios\step-analysis.spec.ts:62:7
...
Locator: getByTestId('scenario-step-analysis-drawer')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('scenario-step-analysis-drawer')
