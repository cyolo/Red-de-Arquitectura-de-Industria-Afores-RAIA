...
- Name: business-scenarios\all-scenarios.spec.ts >> All Business Scenarios Parameterized E2E Verification >> RAIA-BS-0011: Verify complete scenario layout and element rendering
...
- main:
  - complementary:
    ...
    - button "Valuación de instrumentos financieros 12 pasos estructurados" [pressed]
  ...
  - link "Volver al Portal Principal":
    - /url: /
  - text: "ID: RAIA-BS-0011 Proposed Pending Validation"
  - heading "Valuación de instrumentos financieros" [level=1]
  - figure "Valuación de instrumentos financieros":
    ...
    - img "Valuación de instrumentos financieros": Diagrama de secuencia vectorial con 14 participantes y 12 interacciones. sd RAIA-BS-0011 alt [Condiciones de Negocio] [else Precio válido] [else Precio ausente] [else Precio fuera de tolerancia] [else Instrumento ilíquido] [else Revisión manual] Catálogo de Instrumentos Proveedor de Precios Valuación de Instrumentos Validación de Precios Gestión de Excepciones Valuación de Portafolio Contabilidad de Inversiones Riesgo de Inversión Asignación de Rendimientos Valuación proveedor validaci n riesgo contabilidad [1] Recuperar instrumentos. [2] Solicitar precios. [3] Entregar información. [4] Validar calidad. [5] Confirmar o rechazar precio. [6] Solicitar revisión cuando corresponda. [7] Entregar precio aprobado. [8] Entregar valores. [9] Entregar exposición. [10] Actualizar posiciones. [11] Entregar valor de acción. [12] Registrar rendimiento.
  - tablist "Secciones del escenario":
    - tab "Pasos y Flujo" [selected]
    - tab "Narrativa Arquitectónica"
  - paragraph: Valuación de instrumentos financieros
  - region "Flujo y Pasos Estructurados (12)":
    - heading "Flujo y Pasos Estructurados (12)" [level=2]
    - button "1 Recuperar instrumentos. Valuación de Instrumentos→Catálogo de Instrumentos SYNCHRONOUS-COMMAND":
      - text: "1"
      - heading "Recuperar instrumentos." [level=3]
      - paragraph: Valuación de Instrumentos→Catálogo de Instrumentos
