...
- Name: business-scenarios\all-scenarios.spec.ts >> All Business Scenarios Parameterized E2E Verification >> RAIA-BS-0008: Verify complete scenario layout and element rendering
...
- main:
  - complementary:
    ...
    - button "Asignación automática a SIEFORE Generacional 12 pasos estructurados" [pressed]
  ...
  - link "Volver al Portal Principal":
    - /url: /
  - text: "ID: RAIA-BS-0008 Proposed Pending Validation"
  - heading "Asignación automática a SIEFORE Generacional" [level=1]
  - figure "Asignación automática a SIEFORE Generacional":
    ...
    - img "Asignación automática a SIEFORE Generacional": Diagrama de secuencia vectorial con 11 participantes y 12 interacciones. sd RAIA-BS-0008 alt [Condiciones de Negocio] [else Primera asignación] [else Transición generacional] [else Cambio permitido] [else Datos inconsistentes] Cuenta Individual Datos del Trabajador Asignación a SIEFORE Catálogo de SIEFORE Gestión Regulatoria de Fondos Transferencia entre SIEFORE Asignación de Acciones Libro Mayor Notificaciones Asignación transferencia [1] Solicitar clasificación. [2] Recuperar datos relevantes. [3] Consultar fondos vigentes. [4] Validar reglas vigentes. [5] Confirmar parámetros. [6] Entregar SIEFORE aplicable. [7] Consultar fondo actual. [8] Solicitar transferencia cuando corresponda. [9] Cancelar y asignar acciones. [10] Registrar movimientos. [11] Confirmar registro. [12] Comunicar resultado.
  - tablist "Secciones del escenario":
    - tab "Pasos y Flujo" [selected]
    - tab "Narrativa Arquitectónica"
  - paragraph: Asignación automática a SIEFORE Generacional
  - region "Flujo y Pasos Estructurados (12)":
    - heading "Flujo y Pasos Estructurados (12)" [level=2]
    - button "1 Solicitar clasificación. Cuenta Individual→Asignación a SIEFORE SYNCHRONOUS-COMMAND":
      - text: "1"
      - heading "Solicitar clasificación." [level=3]
      - paragraph: Cuenta Individual→Asignación a SIEFORE
