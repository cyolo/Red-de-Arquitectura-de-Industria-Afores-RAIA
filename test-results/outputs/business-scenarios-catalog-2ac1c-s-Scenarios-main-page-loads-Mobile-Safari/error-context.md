...
- Name: business-scenarios\catalog.spec.ts >> Business Scenarios Catalog >> RAIA-BS-E2E-001: Validate Business Scenarios main page loads
- Location: tests\e2e\business-scenarios\catalog.spec.ts:9:7
...
Locator: getByRole('heading', { name: 'RAIA Business Scenarios', level: 1 })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'RAIA Business Scenarios', level: 1 })
