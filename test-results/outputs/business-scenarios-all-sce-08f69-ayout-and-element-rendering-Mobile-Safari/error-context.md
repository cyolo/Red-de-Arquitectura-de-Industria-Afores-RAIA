...
- Name: business-scenarios\all-scenarios.spec.ts >> All Business Scenarios Parameterized E2E Verification >> RAIA-BS-0017: Verify complete scenario layout and element rendering
...
- main:
  - complementary:
    ...
    - button "Transferencia de recursos al Fondo 15 pasos estructurados" [pressed]
    - button "Cálculo y gestión del complemento de pensión 17 pasos estructurados"
  - link "Volver al Portal Principal":
    - /url: /
  - text: "ID: RAIA-BS-0017 Proposed Pending Validation"
  - heading "Transferencia de recursos al Fondo" [level=1]
  - figure "Transferencia de recursos al Fondo":
    ...
    - img "Transferencia de recursos al Fondo": Diagrama de secuencia vectorial con 13 participantes y 15 interacciones. sd RAIA-BS-0017 alt [Excepciones] [else Fallo de conexión] Identificación de Cuentas Elegibles AFORE Administración de Cuenta Individual Desinversión de Recursos Transferencia al Fondo Institución Financiera BDNSAR Conciliación Información Regulatoria Notificaciones Identificación Desinversión transferencia [1] Emitir instrucción autorizada. [2] Validar estado actual. [3] Confirmar condición. [4] Determinar saldo elegible. [5] Solicitar liberación de recursos. [6] Entregar monto. [7] Instruir liquidación. [8] Transferir recursos. [9] Confirmar recepción. [10] Registrar disposición. [11] Actualizar estado. [12] Conciliar monto. [13] Confirmar cierre. [14] Reportar operación. [15] Emitir comunicación.
  - tablist "Secciones del escenario":
    - tab "Pasos y Flujo" [selected]
    - tab "Narrativa Arquitectónica"
  - paragraph: Transferencia de recursos al Fondo
  - region "Flujo y Pasos Estructurados (15)":
    - heading "Flujo y Pasos Estructurados (15)" [level=2]
    - button "1 Emitir instrucción autorizada. Identificación→AFORE SYNCHRONOUS-COMMAND":
      - text: "1"
      - heading "Emitir instrucción autorizada." [level=3]
      - paragraph: Identificación→AFORE
