...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">083</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-083\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">084</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-084\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">085</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-085\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">087</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-087\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">088</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-088\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">101</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-101\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">102</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-102\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">106</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-106\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">107</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-107\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">109</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-109\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">124</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-124\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.35 (foreground color: #848d9b, background color: #ffffff, font size: 6.0pt (8px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"font-mono text-[8px] opacity-60\">125</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "button[data-service-domain-id=\"RAIA-SD-125\"] > .opacity-60.text-\\[8px\\].font-mono",
+         ],
+       },
+       Object {
+         "all": Array [],
  ...
  - main [ref=e26]:
    - generic [ref=e27]:
          ...
          - generic [ref=e65]:
            ...
            - generic [ref=e70]:
              - generic [ref=e71]:
                ...
                - generic [ref=e75]:
                  - button "162 Atención Omnicanal" [active] [ref=e76] [cursor=pointer]:
                    - generic [ref=e77]: "162"
      ...
      - generic [ref=e1138]:
        - generic [ref=e1139]:
          - generic [ref=e1140]:
            - generic [ref=e1141]: RAIA-SD-162
            - generic [ref=e1142]: Service Domain
          - button [ref=e1143]:
            - img [ref=e1144]
        - generic [ref=e1147]:
          - generic [ref=e1148]:
            - heading "Atención Omnicanal" [level=2] [ref=e1149]
            - paragraph [ref=e1150]: Atención Omnicanal (English)
          - generic [ref=e1151]:
            - heading "Definición" [level=4] [ref=e1152]
            - paragraph [ref=e1153]: "Proporciona capacidades normalizadas de industria para la administración y control de: Atención Omnicanal."
          - generic [ref=e1154]:
            - heading "Objeto Foco" [level=4] [ref=e1155]
            - generic [ref=e1156]:
              - text: Objeto de Atención Omnicanal
              - paragraph [ref=e1157]: "Registro o entidad que representa el estado y control de: Atención Omnicanal."
          - generic [ref=e1158]:
            - heading "Gobierno" [level=4] [ref=e1159]
            - generic [ref=e1160]:
              - generic [ref=e1161]:
                - img [ref=e1162]
                - generic [ref=e1166]:
                  - generic [ref=e1167]: "Responsable (Accountable):"
                  - text: AFORE, Empresa Operadora
              - generic [ref=e1168]:
                - img [ref=e1169]
                - generic [ref=e1171]:
                  - generic [ref=e1172]: "Participantes:"
                  - text: Trabajador, CONSAR
          - link "Ver Ficha Técnica Completa" [ref=e1174] [cursor=pointer]:
            - /url: /service-domains/atencion-omnicanal
            - text: Ver Ficha Técnica Completa
            - img [ref=e1175]
          - generic [ref=e1177]:
            - heading "Relaciones de Extremo a Extremo" [level=4] [ref=e1178]:
              - img [ref=e1179]
              - text: Relaciones de Extremo a Extremo
            - paragraph [ref=e1184]: Visualiza el flujo de dependencias directo. Haz click en un nodo para seleccionarlo.
            - application [ref=e1186]:
              - group [ref=e1189]: Atención Omnicanal
              - img
              - generic "Control Panel" [ref=e1190]:
                - button "Zoom In" [ref=e1191] [cursor=pointer]:
                  - img [ref=e1192]
                - button "Zoom Out" [ref=e1194] [cursor=pointer]:
                  - img [ref=e1195]
                - button "Fit View" [ref=e1197] [cursor=pointer]:
                  - img [ref=e1198]
  - contentinfo [ref=e1201]:
    - generic [ref=e1202]:
      - paragraph [ref=e1203]: DisclaimerRAIA es una arquitectura de referencia y no sustituye las leyes, disposiciones, criterios, manuales ni publicaciones oficiales de las autoridades mexicanas.
      - paragraph [ref=e1204]: "RAIA 0.1.0 © 2026. Licencia: Código MIT, Modelos CC BY 4.0."
  - button "Open Next.js Dev Tools" [ref=e1210] [cursor=pointer]:
    - img [ref=e1211]
  - alert [ref=e1214]
```