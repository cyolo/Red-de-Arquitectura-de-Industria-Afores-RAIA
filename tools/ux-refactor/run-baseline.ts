...
const OUTPUT_DIR = path.join(__dirname, '../../docs/ux-refactor/before');
...
async function runBaseline() {
  console.log('Starting RAIA Visual Refactor BEFORE Baseline...');
...
runBaseline().catch(err => {
  console.error('Baseline crashed:', err);
});
