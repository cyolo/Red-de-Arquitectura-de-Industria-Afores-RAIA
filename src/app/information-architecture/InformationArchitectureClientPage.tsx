...
const DynamicWorkspace = dynamic(
  () => import("../../features/information-architecture/components/InformationArchitectureWorkspace"),
  {
    ssr: false,
    loading: () => (
      <div className="flex-1 flex items-center justify-center bg-slate-50 min-h-[400px]">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">
            Cargando Arquitectura de Información...
          </p>
        </div>
      </div>
    )
...
export default function InformationArchitectureClientPage() {
