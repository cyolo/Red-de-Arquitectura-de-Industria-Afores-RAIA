...
const DynamicWorkspace = dynamic(
  () => import("../../features/business-object-model/components/BusinessObjectModelWorkspace"),
  {
    ssr: false,
    loading: () => (
      <div className="flex-1 flex items-center justify-center bg-slate-50 min-h-[400px]">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">
            Cargando Business Object Model...
          </p>
        </div>
      </div>
    )
...
export default function BusinessObjectClientPage() {
